...
namespace Logic
{
    public class RowPrefab : MonoBehaviour
    {
        ...
        {
            SetFix();
            DataBase.instance.allPixelFalse += SetThisLineFalse;
        }
        ...
        public void SetDeafault()
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                if (DataBase.instance.maps[i + (idx * 15)] == "00" || DataBase.instance.maps[i + (idx * 15)] == "10")
                {
                    if (i != 0 && count0 == 0)
                        num.Add(count);
                    count0++;
                ...
                else if (DataBase.instance.maps[i + (idx * 15)] == "01" || DataBase.instance.maps[i + (idx * 15)] == "11")
                {
                    count0 = 0;
                    count++;
                }
