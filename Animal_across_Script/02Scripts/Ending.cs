...
public class Ending : MonoBehaviour
{
    ...
    {
        Instantiate(Bronze, Player.transform.position + new Vector3(-2, 0.5f, 0), Quaternion.identity);
        Instantiate(Silver, Player.transform.position + new Vector3(2, 0.5f, 0), Quaternion.identity);
    ...
    public IEnumerator ENDING()//엔딩조건을 만족하면 실행할함수
    {
        ...
        Comment.instance.CommentPrint("\"신너굴님 채무를 전액상환하신걸 축하드립니다.\n신너굴님께서 저희와 함께 섬을 나가시겠어요 ?\"");
        yield return new WaitForSeconds(0.1f);
